          ...
          <div className="hidden lg:flex flex-col w-full ml-8">
            ...
            <div className="flex justify-between items-center border-b border-gray-300 pb-2 text-xs text-gray-500">
              <div className="flex gap-6">
                <span className="flex items-center gap-1 border-r border-gray-300 pr-3">
            ...
            <div className="flex items-center justify-between pt-4 text-sm">
              <div className="flex space-x-8">
                <Link to="/" className={`hover:text-black ${isActiveTab('/') ? 'font-bold text-black' : 'text-gray-500'}`}>Home</Link>
                <Link to="/about" className={`hover:text-black ${isActiveTab('/about') ? 'font-bold text-black' : 'text-gray-500'}`}>About</Link>
                <Link to="/service" className={`hover:text-black ${isActiveTab('/service') ? 'font-bold text-black' : 'text-gray-500'}`}>Service</Link>
                <Link to="/blog" className={`hover:text-black ${isActiveTab('/blog') ? 'font-bold text-black' : 'text-gray-500'}`}>Blog</Link>
                <Link to="/contact" className={`hover:text-black ${isActiveTab('/contact') ? 'font-bold text-black' : 'text-gray-500'}`}>Contact</Link>
              </div>
