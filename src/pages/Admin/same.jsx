          ...
          {blogs && blogs.map((blogs, index) => {
            ...
            >
              <div className="relative">
                <img
                  src={`${BaseUrl}/images/${blogs.image}`}
                  className="w-full h-36 object-cover"
                />
                <div className="absolute top-2 left-2 bg-yellow-200 text-black px-2 py-1 rounded text-xs">
                  {blogs.category}
                </div>
              </div>
              <div className="p-3">
                {/* <p className="text-xs text-gray-500 mb-1">{blogs.date}</p> */}
                <h3 className="text-sm font-semibold mt-1">{blogs.title}</h3>
